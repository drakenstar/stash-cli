...
func TestBind(t *testing.T) {
	...
	t.Run("kitchen sink", func(t *testing.T) {
		var dst testDest
		a := New(`foo=bar baz=foo qux=99 quux=2025-09-12 corge grault=false "garply value" waldo=foo waldo=bar fred plugh=custom remaining1 remaining2`)
		err := Bind(a, &dst)
